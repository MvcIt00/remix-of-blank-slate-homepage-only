...
\restrict rUNibcxdFc7BQ1UvASqKScyAWlG7fnIrRoLd03tOX3oUdS1dbRPlNlpIYJ0otf9
...
CREATE VIEW public.vw_anagrafiche_complete WITH (security_invoker='on') AS
 SELECT a.id_anagrafica,
    ...
    adm.codice_univoco,
    adm.iban,
    adm.pagamento AS modalita_pagamento_default,
    adm.esente_iva,
    c.id_contatto AS contatto_principale_id,
    c.nome AS contatto_principale_nome,
    c.telefono AS contatto_principale_telefono,
    c.email AS contatto_principale_email
   FROM (((public."Anagrafiche" a
     ...
     LEFT JOIN public.an_dati_amministrativi adm ON (((a.id_anagrafica = adm.id_anagrafica) AND (adm.is_cancellato = false))))
     LEFT JOIN LATERAL ( SELECT an_contatti.id_contatto,
            an_contatti.id_anagrafica,
            an_contatti.id_sede,
            an_contatti.nome,
            an_contatti.email,
            an_contatti.telefono,
            an_contatti.created_at,
            an_contatti.is_aziendale,
            an_contatti.is_referente,
            an_contatti.is_cancellato
          ...
          ORDER BY an_contatti.created_at
         LIMIT 1) c ON (true))
  WHERE (a.is_cancellato = false);


--
-- Name: VIEW vw_anagrafiche_complete; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.vw_anagrafiche_complete IS 'Vista completa anagrafiche con JOIN di sede legale, dati amministrativi e contatto principale. Usare questa vista per caricare tutti i dati di un''anagrafica in una singola query.';
...
\unrestrict rUNibcxdFc7BQ1UvASqKScyAWlG7fnIrRoLd03tOX3oUdS1dbRPlNlpIYJ0otf9
