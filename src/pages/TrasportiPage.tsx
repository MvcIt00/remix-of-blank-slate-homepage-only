  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Trasporti</h1>
          <p className="text-muted-foreground mt-1">Monitoraggio trasporti: richiesti, confermati, completati</p>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={handleConfig}>
            <Settings className="h-5 w-4 mr-2" />
            Config
          </Button>
        </div>
      </div>
